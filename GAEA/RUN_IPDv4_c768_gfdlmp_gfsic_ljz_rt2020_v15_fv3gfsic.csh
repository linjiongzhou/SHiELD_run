...
#SBATCH --cluster=c3
#SBATCH --nodes=96
#SBATCH --export=NAME=20150801.00Z,MEMO=_RT2018,EXE=x,LX=16,CPN=32,ALL

# This script is optimized for GFDL MP runs 
# using six-tile c768L64 FV3GFS restarts
...
# input filesets
set ICS  = ${INPUT_DATA}/FV3GFS_ICs.v20190701/data/${NAME}_IC
