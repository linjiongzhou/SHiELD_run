...
#SBATCH --nodes=1
#SBATCH --qos=urgent
#SBATCH --export=NAME=20150801.00Z,MEMO=_RT2018,EXE=x,LX=12,CPN=36,ALL

# To run supercell case, add -DSUPER_K to mk_makefile
...
#    set fdiag = "6.,12.,18.,24.,30.,36.,42.,48.,54.,60.,66.,72.,78.,84.,90.,96.,102.,108.,114.,120.,126.,132.,138.,144.,150.,156.,162.,168.,174.,180.,186.,192.,198.,204.,210.,216.,222.,228.,234.,240."
	...
	# determine whether FSBM is done
	set do_fsbm = ".true."

    # set various debug options
    set no_dycore = ".false."
    set dycore_only = ".true."
...
# Date specific ICs
ln -sf /lustre/f2/dev/Linjiong.Zhou/IC_for_DP/* INPUT/

if ( $do_fsbm == ".true." ) then
  # FSBM input
  ln -sf /lustre/f2/dev/gfdl/Linjiong.Zhou/FSBM_for_GFDL/SBM_input_33 .
  ln -sf /lustre/f2/dev/gfdl/Linjiong.Zhou/FSBM_for_GFDL/scattering_tables_2layer_high_quad_1dT_1%fw_110 .
endif
