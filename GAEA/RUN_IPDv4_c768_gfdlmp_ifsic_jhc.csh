...
# This script is optimized for GFDL MP runs using IFS ICs
# Jan-Huey.Chen@noaa.gov

set echo

set BASEDIR    = "/lustre/f1/${USER}/NGGPS_NEW/"
set INPUT_DATA = "/lustre/f1/unswept/Shannon.Rees/FV3_INPUT_DATA/"
set BUILD_AREA = "~${USER}/NGGPS_NEW/fv3_gfs_build/"
...
# input filesets
set EC_data = /lustre/f1/unswept/Jan-Huey.Chen/EC_data/IFS_AN0_${NAME}.nc
...
set gfdl_archive = /archive/${USER}/NGGPS_NEW/${RELEASE}/${NAME}.${CASE}.${TYPE}.${MODE}.${MONO}${MEMO}/
...
/
 ...
 &gfs_physics_nml
       ...
       debug          = .false.
!      xkzminv = 0.0 
       c0s_deep = 0.0024    ! default=0.002; for Ocean
!      c1_deep = 0.002     ! default = 0.002
!      asolfac_deep = 0.89    ! c0_land_deep = c0s_deep * asolfac_deep 
!      clam_deep = 0.1
       c0s_shal = 0.0024  ! default=0.002
!      c1_shal = 5.e-4  ! default=5.e-4 
!      asolfac_shal = 0.89    ! c0_land_shal = c0s_shal * asolfac_shal
!      clam_shal = 0.3
/
