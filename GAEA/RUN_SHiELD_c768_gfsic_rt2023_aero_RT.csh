...
$y $m $d $h 0 0 
EOF
cat ${BUILD_AREA}/tables/diag_table_RT >> diag_table
sed -i "s/YYYY MM DD CYC/${y} ${m} ${d} ${h}/g" diag_table # [MJM:2021MAR15] Needed for improved date math in diag_manager when first_time_step=".true."
