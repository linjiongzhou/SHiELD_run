...
# This script is designed to run C-SHiELD
# This script is optimized for GFDL MP runs using GFS ICs
# Kai-Yuan.Cheng@noaa.gov and Linjiong.Zhou@noaa.gov
...
$y $m $d $h 0 0 
EOF
cat ${BUILD_AREA}/tables/diag_table_6species_hwt >> diag_table
...
&namsfc
       ...
       FNZORC   = "igbp",
       FNALBC   = "INPUT/fix_sfc/${CRES}.snowfree_albedo.tileX.nc",
       FNALBC2  = "INPUT/fix_sfc/${CRES}.facsf.tileX.nc",
       FNAISC   = "INPUT/CFSR.SEAICE.1982.2012.monthly.clim.grb",
       FNTG3C   = "INPUT/fix_sfc/${CRES}.substrate_temperature.tileX.nc",
       FNVEGC   = "INPUT/fix_sfc/${CRES}.vegetation_greenness.tileX.nc",
       FNVETC   = "INPUT/fix_sfc/${CRES}.vegetation_type.tileX.nc",
       FNSOTC   = "INPUT/fix_sfc/${CRES}.soil_type.tileX.nc",
       FNSMCC   = "INPUT/global_soilmgldas.t1534.3072.1536.grb",
       FNMSKH   = "INPUT/global_slmask.t1534.3072.1536.grb",
       FNTSFA   = "",
       FNACNA   = "",
       FNSNOA   = "",
       FNVMNC   = "INPUT/fix_sfc/${CRES}.vegetation_greenness.tileX.nc",
       FNVMXC   = "INPUT/fix_sfc/${CRES}.vegetation_greenness.tileX.nc",
       FNSLPC   = "INPUT/fix_sfc/${CRES}.slope_type.tileX.nc",
       FNABSC   = "INPUT/fix_sfc/${CRES}.maximum_snow_albedo.tileX.nc",
       LDEBUG   =.false.,
       FSMCL(2) = 99999
       FSMCL(3) = 99999
       FSMCL(4) = 99999
...
########################################################################
    ...
    cd $dateDir
      ...
      if ( ! -d ${begindate}_phys3d ) mkdir -p ${begindate}_phys3d
      mv phys3d*.nc* ${begindate}_phys3d
      mv ${begindate}_phys3d ../.
    ...
    #sbatch --export=source=$WORKDIR/history/${begindate}_phys3d,destination=gfdl:$gfdl_archive/history/${begindate}_phys3d,extension=tar,type=history --output=$HOME/STDOUT/%x.o%j $SEND_FILE
