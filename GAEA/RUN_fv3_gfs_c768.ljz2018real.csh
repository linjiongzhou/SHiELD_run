#!/bin/tcsh 
#PBS -o /lustre/f1/Linjiong.Zhou/NGGPS/stdout/
#PBS -N C768_cases20_ir1.0_gfdlmp_20180625mods_rt1_ysu_newic_holefix_inline_bdiff_mlm_gfs_sedih
#PBS -q urgent
#PBS -l qos=windfall
#PBS -A nggps_gfdl
...
set BUILD_AREA = "/lustre/f1/unswept/${USER}/NGGPS_IPDv4/fv3_gfs_build"
...
set MEMO = "_ir1.0_gfdlmp_20180625mods_rt1_ysu_newic_holefix_inline_bdiff_mlm_gfs_sedih"
...
set executable = ${BUILD_AREA}/FV3GFS/BUILD/bin/fv3_gfs_${TYPE}.${COMP}.${MODE}.20180625mods_rt1.x

# input filesets
set ICS  = ${INPUT_DATA}/${CASE}/hole_fix/${NAME}_IC/GFS_INPUT.tar
set FIX  = ${INPUT_DATA}/fix_am/
set GFS  = ${INPUT_DATA}/GFS_STD_INPUT.tar
set GRID = ${INPUT_DATA}/${CASE}/hole_fix/GRID_DATA.tar
set FIX_bqx  = /lustre/f1/unswept/Baoqiang.Xiang/archive/NGGPS/climo_data
...
ln -sf /lustre/f1/unswept/Xi.Chen/FV3/Fv3py_run/important/v20171016.fv3solo/pyhitopo/C${res}f${hires_oro_factor}/* INPUT/
