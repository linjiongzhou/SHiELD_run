...
#SBATCH --job-name=C1152_20150801.00Z
#SBATCH --partition=batch
#SBATCH --account=gfdl_w
#SBATCH --time=03:00:00
#SBATCH --cluster=c3
#SBATCH --nodes=216
#SBATCH --export=NAME=20150801.00Z,MEMO=_RT2018,EXE=x,LX=24,CPN=32,ALL
...
cp ${BUILD_AREA}/FV3GFS/RUN/RETRO/field_table_6species_aero field_table
cp $executable .
