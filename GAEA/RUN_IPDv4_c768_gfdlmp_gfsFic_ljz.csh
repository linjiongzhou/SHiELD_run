...
#PBS -N C768_2016100100_mj_fv3gfs
#PBS -q batch
#PBS -l qos=norm
#PBS -A gfdl_w
...
# input filesets
#set ICS  = /lustre/f1/unswept/Shannon.McElhinney/FV3_INPUT_DATA/20190207_mj_fv3gfs/${CASE}/${NAME}_IC/GFS_INPUT.tar
set ICDIR  = /lustre/f1/Shannon.Rees/Mingjing/INPUT/${NAME}/C768/
